...
Versi Androit dibuat menggunakan Androit Studio

The PC version was created using Windows Powershell, which is sometimes considered a virus, but don't worry, there are no viruses in the file.
The Android version was created using Android Studio.
